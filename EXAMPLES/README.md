For the following examples I will use pillow, even though this branch does not need pillow. This is purely for the "obviousness" of how the library operates. 
